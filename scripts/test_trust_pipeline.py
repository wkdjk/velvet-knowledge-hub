...
# + needs_review gate (C-15, 2026-07-05, directive §4).
#
...
# majority-EN-pick logic with synthetic data replicating the exact live cases
# found in the 2026-07-05 audit (variant legal-entity markers on the same
# company; genuinely unmapped companies).
#
